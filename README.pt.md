...
Editor de jogos salvos, dados do jogo e mapas para **Jagged Alliance 2** numa única janela.

> [!NOTE]
> **A tradução para português está a caminho.** Enquanto isso, todas as informações estão na [versão em inglês](README.md).
...
- **[The Bear's Pit — JA Galaxy Forum](https://thepit.ja-galaxy-forum.com/)** — o lar do modding de Jagged Alliance 2 e 1.13: mods, mapas, ferramentas e ajuda.
- **[Discord](https://discord.com/invite/Ku2H9Hf)** — converse com outros jogadores e modders.
